...
export const alohaStops: AlohaStop[] = [
  ...
  s({
    ...
    images: [IMG.market[2], IMG.market[3], IMG.market[0]], hours: hoursLate, price_tier: 1, avg_minutes: 70, avg_spend: 0,
    rating: 4.5, review_count: 240, point_rule_id: 'pr_visit_standard', passport_stamp_id: 'stm_hono_arts',
    geofence_m: 180, qr_enabled: false, featured: false, moods: ['local', 'entertainment', 'shopping', 'free'], group_friendly: true,
  }),
  s({
    ...
    images: [IMG.banners[4], IMG.banners[0], IMG.adventure[0]], hours: hoursLate, price_tier: 1, avg_minutes: 90, avg_spend: 0,
    rating: 4.6, review_count: 305, point_rule_id: 'pr_visit_standard', passport_stamp_id: 'stm_hono_music',
    geofence_m: 150, qr_enabled: true, featured: false, moods: ['entertainment', 'romantic', 'local', 'free'], group_friendly: true,
  }),
  s({
  ...
  s({
    id: 'stp_shore', business_id: 'biz_trail', region_id: 'rg_waikiki', category_id: 'cat_attractions',
    name: 'Waikīkī Shoreline Walk', tagline: 'Sunset promenade from Kūhiō to Kapiʻolani',
    description: 'A free oceanfront walk with benches, lei stands and the best golden-hour light in Waikīkī. No ticket, no reservation.',
    address: 'Kalākaua Ave shoreline, Honolulu, HI 96815', coords: { lat: 21.2758, lng: -157.8231 },
    images: [IMG.adventure[0], IMG.banners[1], IMG.wellness[0]], hours: hoursLate, price_tier: 1, avg_minutes: 50, avg_spend: 0,
    rating: 4.8, review_count: 2104, point_rule_id: 'pr_visit_standard',
    geofence_m: 180, qr_enabled: false, featured: true, moods: ['romantic', 'relaxing', 'beach', 'outdoors', 'free'], group_friendly: true,
  }),
  s({
    id: 'stp_kailua_path', business_id: 'biz_trail', region_id: 'rg_windward', category_id: 'cat_activities',
    name: 'Kailua Beach Path', tagline: 'Soft sand, turquoise water, no entry fee',
    description: 'A public beach path along Kailua Bay. Bring water and stay as long as you like — the Stop is the walk, not a ticketed activity.',
    address: 'Kailua Beach Park, Kailua, HI 96734', coords: { lat: 21.3976, lng: -157.7273 },
    images: [IMG.adventure[2], IMG.wellness[1], IMG.banners[2]], hours: hoursStd, price_tier: 1, avg_minutes: 70, avg_spend: 0,
    rating: 4.9, review_count: 1560, point_rule_id: 'pr_visit_standard',
    geofence_m: 220, qr_enabled: false, featured: false, moods: ['outdoors', 'relaxing', 'romantic', 'family', 'free'], group_friendly: true,
  }),
  s({
    id: 'stp_magic_island', business_id: 'biz_trail', region_id: 'rg_honolulu', category_id: 'cat_attractions',
    name: 'Magic Island Promenade', tagline: 'Harbor views and a golden-hour loop',
    description: 'A flat, free waterfront loop at Ala Moana. Locals walk it at sunset; the Stop is the promenade itself.',
    address: '1201 Ala Moana Blvd, Honolulu, HI 96814', coords: { lat: 21.2865, lng: -157.8468 },
    images: [IMG.banners[3], IMG.adventure[0], IMG.wellness[2]], hours: hoursLate, price_tier: 1, avg_minutes: 55, avg_spend: 0,
    rating: 4.7, review_count: 980, point_rule_id: 'pr_visit_standard',
    geofence_m: 200, qr_enabled: false, featured: false, moods: ['romantic', 'relaxing', 'outdoors', 'local', 'free'], group_friendly: true,
  }),
];
...
export const hunts: Hunt[] = [
  ...
  {
    id: 'hnt_free_golden', island_id: 'isl_oahu', region_id: 'rg_waikiki', name: 'Golden Hour Free Walk',
    subtitle: 'Three shoreline Stops, zero spend', description: 'A walkable sunset loop that never asks for a ticket or a tab. Waikīkī shoreline, Magic Island, then slack-key at the harbor — all free.',
    hero: IMG.banners[1], category_id: 'cat_attractions', completion_points: 600, bonus_points: 100,
    bonus_condition: 'Finish all three Stops the same evening', starts_at: '2026-05-01T00:00:00Z', ends_at: '2026-12-31T23:59:00Z',
    status: 'active', est_minutes: 180, group_friendly: true, featured: true,
  },
  {
...
export const huntStops: HuntStop[] = [
  ...
  { id: 'hs_20', hunt_id: 'hnt_free_golden', stop_id: 'stp_shore', sequence: 1, required: true, hint: 'Start on the Waikīkī shoreline.' },
  { id: 'hs_21', hunt_id: 'hnt_free_golden', stop_id: 'stp_magic_island', sequence: 2, required: true, hint: 'Walk the Magic Island loop at golden hour.' },
  { id: 'hs_22', hunt_id: 'hnt_free_golden', stop_id: 'stp_harbor', sequence: 3, required: true, hint: 'End with slack-key on the pier — no cover.' },
